 ...
 * test the implementation of the edu.uw.cse.testbayes.Runner.tests331.RatNum class. For a more complete test, see
 * <tt>edu.uw.cse.testbayes.Runner.tests331.RatNumTest</tt>. This class, <tt>RatNumSmallTest</tt>, deliberately
 * omits some of the tests from <tt>edu.uw.cse.testbayes.Runner.tests331.RatNumTest</tt>, to permit comparing the
...
public final class RatNumSmallTest {
  ...
  @RunWith(Suite.class)
  @Suite.SuiteClasses({})
  public static final class ImplementationTests
  {
