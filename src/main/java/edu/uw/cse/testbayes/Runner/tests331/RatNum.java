...
/** <b>edu.uw.cse.testbayes.Runner.tests331.RatNum</b> represents an <b>immutable</b> rational number.
...
public final class RatNum extends Number implements Comparable<RatNum> {
  ...
  //   A edu.uw.cse.testbayes.Runner.tests331.RatNum r is NaN if r.denom = 0, (r.numer / r.denom) otherwise.
  // (An abstraction function explains what the state of the fields in a
  // edu.uw.cse.testbayes.Runner.tests331.RatNum represents.  In this case, a rational number can be
  // understood as the result of dividing two integers, or not-a-number
  // if we would be dividing by zero.)

  // Representation invariant for every edu.uw.cse.testbayes.Runner.tests331.RatNum r:
  //   (r.denom >= 0) &&
  ...
  // instances of a edu.uw.cse.testbayes.Runner.tests331.RatNum)

  /** A constant holding a Not-a-Number (NaN) value of type edu.uw.cse.testbayes.Runner.tests331.RatNum */
  public static final RatNum NaN = new RatNum(1, 0);

  /** A constant holding a zero value of type edu.uw.cse.testbayes.Runner.tests331.RatNum */
  public static final RatNum ZERO = new RatNum(0);

  /** @param n The value of the new edu.uw.cse.testbayes.Runner.tests331.RatNum.
        @effects Constructs a new edu.uw.cse.testbayes.Runner.tests331.RatNum = n.
   */
  public RatNum(int n) {
    numer = n;
    denom = 1;
  ...
  /** @param n The numerator of the new edu.uw.cse.testbayes.Runner.tests331.RatNum.
        @param d The denominator of the new edu.uw.cse.testbayes.Runner.tests331.RatNum.
        @effects If d = 0, constructs a new edu.uw.cse.testbayes.Runner.tests331.RatNum = NaN.  Else
         constructs a new edu.uw.cse.testbayes.Runner.tests331.RatNum = (n / d).
   */
  ...
  private void checkRep() {
    assert (denom >= 0) : "Denominator of a edu.uw.cse.testbayes.Runner.tests331.RatNum cannot be less than zero";

    if (denom > 0) {
      int thisGcd = gcd(numer, denom);
      assert (thisGcd == 1 || thisGcd == -1) : "edu.uw.cse.testbayes.Runner.tests331.RatNum not in lowest form";
    }
  }
  ...
  public boolean isNegative() {
    return (compareTo(RatNum.ZERO) < 0);
  }
  ...
  /** Compares two RatNums.
        @param rn The edu.uw.cse.testbayes.Runner.tests331.RatNum to be compared.
        @requires rn != null
  ...
  /** Returns the additive inverse of this edu.uw.cse.testbayes.Runner.tests331.RatNum.
  ...
  /** Addition operation.
        ...
        @requires arg != null
        @return a edu.uw.cse.testbayes.Runner.tests331.RatNum equal to (this + arg).
  ...
  /** Standard equality operation.
        ...
        @return true if and only if 'obj' is an instance of a edu.uw.cse.testbayes.Runner.tests331.RatNum
  ...
  /** Makes a edu.uw.cse.testbayes.Runner.tests331.RatNum from a string describing it.
        ...
        edu.uw.cse.testbayes.Runner.tests331.RatNum r = ( N / M ), letting M be 1 in the case
